...
""";
    ...
    internal const string IgnoreCreateSyncVersionAttributeSource = $$"""
// <auto-generated/>
namespace Zomp.SyncMethodGenerator
{
    #if !SYNC_METHOD_GENERATOR_DISABLE_ATTRIBUTE_GENERATION
    /// <summary>
    /// An attribute that can be used to ignore the automatic generation of a synchronous version of an async method.
    ///
    ...
    internal class {{SyncMethodSourceGenerator.IgnoreCreateSyncVersionAttribute}} : System.Attribute
    {
    }
    #endif
}
